...
Route::post('/professeur/cs/creation/getNotation', 'ProfesseurCSController@getNotation');
Route::post('/professeur/cs/creation/getOneNotation', 'ProfesseurCSController@getOneNotation');
Route::post('/professeur/cs/creation/getFilieres', 'ProfesseurCSController@getFilieres');
Route::post('/professeur/cs/creation/addNotation', 'ProfesseurCSController@addNotation');
Route::post('/professeur/cs/creation/supprimer', 'ProfesseurCSController@supprimer');
Route::post('/professeur/cs/creation/getNotationIndicateur', 'ProfesseurCSController@getNotationIndicateur');
Route::post('/professeur/cs/creation/setNotationIndicateur', 'ProfesseurCSController@setNotationIndicateur');
