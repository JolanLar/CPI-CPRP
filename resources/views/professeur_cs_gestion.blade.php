            ...
            <div class="col-lg-12">
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        <label for="select">Choix d'une notation </label>
                        <select class="select form-control" id="notation" name="notation">
                            @foreach($lesNotations as $uneNotation)
                                <option value="{{ $uneNotation->idNotation }}-{{ $uneNotation->annee }}-{{ $uneNotation->idAnneeEtude }}">
                                    {{ $uneNotation->libelleNotation }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <select class="select form-control" id="etudiantcs" name="etudiantcs">
                        </select>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="form-group">
                        <label for="select" id="obs">Observation : </label>
                        <textarea class="form-control" id="observationcs"></textarea>
                    </div>
                </div>
            </div>
